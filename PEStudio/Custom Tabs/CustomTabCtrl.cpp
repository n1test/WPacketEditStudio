/*
  ...
  *Distributed under the terms of the zlib/libpng public license.*
  ...
  Author: 
	...
	Andrzej Markowski (codeguru.com) - CCustomTabCtrl
...
// The tab control used continuously (options, sub page selection, etc.)
//
...
BOOL CCustomTabCtrl::NotifyParent(UINT code, int nItem, CPoint pt)
{
	...
	if(nItem>=0)
	{
		_tcscpy_s(nmh.pszText, 30, m_aItems[nItem]->m_sText);
