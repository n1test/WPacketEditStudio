...
// Used by the EnBitmap bitmap rendering
//
...
void CToolBar24::SetFullColorImage(UINT id, COLORREF rgbBack, INT x, INT y)
{
	m_bmToolbar.LoadBitmap(id);
	m_imgToolbar.Create(x, y, ILC_COLOR24|ILC_MASK, 1, 1);
	...
	m_imgToolbarDis.Create(x, y, ILC_COLOR24|ILC_MASK, 1, 1);
	...
	m_imgToolbarNA.Create(x, y, ILC_COLOR24|ILC_MASK, 1, 1);
